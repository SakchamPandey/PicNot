...
<div class="jumbotron">
  <h1 style="color:mediumslateblue; font-weight:bold;"class="display-4">(: A Team Of PicNot :)</h1>
  <h2 style="color:teal; font-weight:bold;">We Are The Web Developers. We Try To Build New Thing.</h2>
</div>
<section class ="my-5">
  <div class="py-5">
    <h2 style="color:darkslategrey; font-weight:bold;"class="text-center">About Us</h2>
  </div>
